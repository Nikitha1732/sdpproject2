...
def print_to_console(request):
    if request.method == "POST":
        user_input = request.POST['Nikitha']
...
def RandomOtp(request):
    if request.method == "POST":
        ...
        return render(request, 'RandomOtp.html', context)  # Correct indentation
    return render(request, 'RandomOtp.html')  # This line should be indented properly
